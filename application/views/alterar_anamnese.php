		...
		<header>
			<div class="row text-center mb-5">
				<div class="col-sm-12 col-12">
					<h1>Alterar Anamnese</h1>
				</div>
			</div>
		</header>
		<form action="<?php echo base_url('anamnese/salvarAlterar/');?>" name="form_add" method="post">
			<div class="row mb-3">
				<div class="col-sm-12 col-12">
